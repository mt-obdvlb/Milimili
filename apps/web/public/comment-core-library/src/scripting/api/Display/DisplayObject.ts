...
module Display {
  ...
  export class DisplayObject implements ISerializable, Runtime.RegisterableObject, Transformable {
    ...
    public setDefaults(defaults: Object = {}): void {
      ...
      try {
        ...
        if (defaults.hasOwnProperty('motion')) {
          ...
          defaults.hasOwnProperty('motionGroup') &&
          defaults['motionGroup'] &&
          defaults['motionGroup'].length > 0
        ) {
    ...
    public addChild(o: DisplayObject): void {
      ...
      this._boundingBox.unionCoord(
        o._anchor.x + o._boundingBox.left,
        o._anchor.y + o._boundingBox.top
      )
      this._boundingBox.unionCoord(
        o._anchor.x + o._boundingBox.right,
        o._anchor.y + o._boundingBox.bottom
      )
      o._parent = this
    ...
    public toString(): string {
      return (
        '[' + (this._name.length > 0 ? this._name : 'displayObject') + ' DisplayObject]@' + this._id
      )
    }
