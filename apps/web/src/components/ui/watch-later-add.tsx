  ...
  return (
    <WithAuth>
      <motion.div
        ...
        className='flex items-center transition-all duration-300 overflow-hidden px-[3px] rounded-[6px] cursor-pointer bg-[#333]/80 h-7'
      >
        {isFavorite ? (
          <svg
            ...
            height='20'
            fill='currentColor'
            className={'select-none  pointer-events-none size-[22px] text-white'}
          >
            <path
          ...
          <svg
            ...
            height='20'
            fill='currentColor'
            className={'select-none shrink-0 pointer-events-none size-[22px] text-white'}
          >
            <path
        ...
        {!isFavorite && hovered && (
          <motion.span
            className={
              'select-none  shrink-0   text-[14px] text-white pointer-events-none ml-1  rounded-[4px] leading-4.5 whitespace-nowrap overflow-hidden'
            }
          >
            加入稍后再看
          </motion.span>
