...
const HeaderBarRightEntryAvatarNoLogin = () => {
  ...
  return (
    <HoverCard openDelay={150} closeDelay={150}>
      <HoverCardTrigger asChild>
        <div
          onClick={handleClick}
          className={'mr-1 min-w-[50px] shrink-0 cursor-pointer text-center'}
        >
          <div className={'mr-0 flex min-w-[50px] flex-col items-center text-center text-[13px]'}>
            <div
              className={
                'size-9 rounded-full bg-[#00AEEC] text-center text-sm leading-9 font-medium tracking-normal text-white'
              }
            >
              {' '}
              登录
      ...
      <HoverCardContent>
        <div className={'w-[359px] rounded-[8px] px-5 py-5.5 text-left'}>
          <p className={'text-text1 mb-[15px] text-sm leading-5 font-medium'}>登录后你可以：</p>
            ...
            {[
              {
                ...
                svg: (
                  <svg
                    ...
                    width='24'
                    height='24'
                    className='login-tip-content-item-icon'
                    fill='currentColor'
                  >
                    <path
              ...
              <div
                key={item?.name}
                className={'text-brand_blue mb-3.5 flex h-[26px] w-1/2 items-center'}
              >
                {item?.svg}
                <span className={'text-text1 ml-1.5 text-sm leading-3.5 break-keep'}>
                  {item?.name}
                </span>
              </div>
            ))}
          ...
          <div
            className={
              'rounded-[8px[ relative block h-10 cursor-pointer py-3.5 text-center text-[0px] leading-5 tracking-normal text-white transition-colors duration-300'
            }
            onClick={handleClick}
          >
          ...
          <div className={'text-text1 mt-4 text-center text-sm leading-5 tracking-normal'}>
            首次使用？
            <span className={'cursor-pointer text-[#00b5e5]'} onClick={handleClick}>
              {' '}
              点我注册
            </span>
          </div>
...
export default HeaderBarRightEntryAvatarNoLogin
