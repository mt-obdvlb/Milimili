...
} from '@/components/ui/hover-card-pure'
...
const HeaderBarRightEntryAvatar = ({ userHomeInfo }: { userHomeInfo?: UserGetInfoHome }) => {
  ...
  return (
    <HoverCardPure openDelay={150} closeDelay={150} open={isOpen} onOpenChange={setIsOpen}>
      ...
      <HoverCardPureContent>
        <AnimatePresence>
          <motion.div
            ...
            className='absolute left-1/2 top-full -translate-x-1/2 pt-5 -ml-3 z-50'
          >
            <div
              className={
            ...
            >
              <div className={'bg-bg1_float w-[300px] rounded-[8px] px-[24px] pb-[18px]'}>
                <div className={'mb-[4px] block size-[80px] opacity-0'}></div>
                <Link
                  target={'_blank'}
                  ...
                  {[
                    {
                      ...
                      link: `/space/${userHomeInfo?.user.id}/relation/follow`,
                    },
                    {
                      name: '粉丝',
                      number: userHomeInfo?.followers,
                      link: `/space/${userHomeInfo?.user.id}/relation/fans`,
                    },
                    {
                      name: '动态',
