  ...
  return (
    <div className={'relative mb-15 w-full max-w-1/2 flex-[0_0_50%] px-[calc(16px*0.5)]'}>
      <div className={'flex items-center justify-start'}>
        <Link className={'mr-[15px]'} target={'_blank'} href={`/space/${user?.id}`}>
        ...
        <div className={'w-[calc(100%-101px)] pr-[15px]'}>
          <Link
            ...
            href={`/space/${user.id}`}
            className={
              'text-text1 mt-0 mb-[5px] text-lg leading-[1.25] font-bold hover:text-brand_blue transition duration-200'
            }
          >
            {user?.name}
          </Link>
