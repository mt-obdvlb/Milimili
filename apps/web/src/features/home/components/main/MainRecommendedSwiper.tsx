    ...
    <div className={'relative col-span-2 row-span-2'}>
      <div className={'relative pt-[69%]'}>
        ...
        >
          <div
            className={
              'bg-graph_bg_regular absolute inset-0 flex flex-row items-center justify-center'
            }
          >
            <Swiper
              ref={swiperRef}
              ...
              {videoSwiperList?.map((item, index) => (
                ...
                >
                  <div className={'relative'}>
                    <div
                      className={
                        'text-text4 bg-graph_bg_regular absolute top-0 left-0 block w-full cursor-none rounded-[6px] pt-[56.25%] whitespace-nowrap'
                      }
                    ></div>
                    <Link
                      target={'_blank'}
                      href={`/video/${item.id}`}
                      className={'bg-graph_bg_regular relative block size-full'}
                    >
                      <picture
                        className={
            ...
            <div className={'absolute right-[15px] bottom-[42px] z-2 flex justify-end'}>
            ...
            <div
              className={'w-(100vw-100px) absolute bottom-[42px] left-[15px] z-2 flex items-center'}
            >
              <Link
