...
const LoginTip = () => {
  ...
  if (isOpen)
    return (
      <div className={'fixed bottom-0 z-10000 flex w-full items-center justify-center'}>
        <div className={'relative -bottom-0.25 flex h-0.25 w-full justify-end px-24'}>
          <div
            className={
              'relative -top-[224px] h-[149px] w-[360px] rounded-[8px] bg-[linear-gradient(99.4deg,#00a3ff_.43%,#00b6f7_99.04%)] p-4.5 text-[16px]'
            }
          >
            <div
              onClick={() => {
              ...
              className={'absolute top-3.5 right-3.5 size-3.5 cursor-pointer'}
            >
              <svg data-v-44fa1932='' viewBox='0 0 100 100' className={'size-auto'}>
                <path
                  data-v-44fa1932=''
                  d='M2 2 L98 98 M 98 2 L2 98Z'
                  strokeWidth='10px'
            ...
            <div className={'mb-1.5 text-[16px] leading-[22px] font-[600] text-white'}>
              登录哔哩哔哩，高清视频免费看！
            </div>
            <div className={'mb-5 text-sm leading-5 font-normal text-white'}>
              更多登录后权益等你解锁
            </div>
            <svg
              data-v-44fa1932=''
            ...
            >
              <g clipPath='url(#clip0_5121_279027)'>
                ...
                <path
                  ...
                  fill='black'
                  stroke='black'
                  strokeWidth='0.658285'
                  strokeLinecap='round'
                  strokeLinejoin='round'
                ></path>
                <path
                  d='M28.7734 58.1149L30.6117 56.6025'
                  stroke='black'
                  strokeWidth='0.658285'
                  strokeLinecap='round'
                  strokeLinejoin='round'
                ...
                ></path>
                <path
                  d='M11.9922 4.42871L15.7543 9.34939'
                  stroke='black'
                  strokeWidth='4.27885'
                  strokeLinecap='round'
                  strokeLinejoin='round'
                ></path>
                <path
                  d='M29.0006 2.13965L26.6719 7.88153'
                  stroke='black'
                  strokeWidth='4.27885'
                  strokeLinecap='round'
                  strokeLinejoin='round'
                ...
                ></path>
                <path
                  d='M12.1445 20.874L17.814 17.9775'
                  stroke='black'
                  strokeWidth='2.63314'
                  strokeLinecap='round'
                  strokeLinejoin='round'
                ></path>
                <path
                  d='M32.6207 18.1194L26.3867 16.8242'
                  stroke='black'
                  strokeWidth='2.63314'
                  strokeLinecap='round'
                  strokeLinejoin='round'
                ...
                ></path>
                <path
                  d='M7.26104 30.7041L2.5 35.7005C3.02169 37.0138 4.48144 37.858 5.97574 37.7593L14.3162 43.33'
                  fill='white'
                ></path>
                <path
                  d='M7.26104 30.7041L2.5 35.7005C3.02169 37.0138 4.48144 37.858 5.97574 37.7593L14.3162 43.33'
                ...
                ></path>
                <path
                  d='M6.04883 32.6855C6.05706 33.2978 6.24138 34.272 7.26172 34.6686'
                  stroke='black'
                  strokeWidth='0.822856'
                  strokeLinecap='round'
                  strokeLinejoin='round'
                ...
                ></path>
                <path
                  d='M12.9824 42.68L15.3374 36.4839'
                  stroke='black'
                  strokeWidth='0.658285'
                  strokeLinecap='round'
                  strokeLinejoin='round'
            ...
            <span
              ...
              className={cn(
                'text-brand_blue relative block h-10 cursor-pointer rounded-[8px] px-0.5 py-2.5 text-center text-[0px] leading-5 font-[600] transition-colors duration-300',
                "before:absolute before:top-0 before:right-0 before:bottom-0 before:left-0 before:rounded-[8px] before:bg-white before:content-['']",
                "after:absolute after:top-0 after:right-0 after:bottom-0 after:left-0 after:text-[14px] after:leading-[40px] after:content-['立即登录']"
              )}
            >
              立即登录
            </span>
